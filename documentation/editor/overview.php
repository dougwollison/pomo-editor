...
<p><?php _e( 'This screen is the translation editor, where you can make changes to the file and recompile it.', 'pomoedit' ); ?></p>

<p><?php printf( __( 'Click the %1$s icon to open an entry for editing, or one of the %2$s icons to add a new entry. When you’re done with your changes to an entry, click the %3$s icon to save, or otherwise the %4$s icon to discard your changes. To delete an entry, click the %5$s icon (this cannot be undone).', 'pomoedit' ), '<i class="dashicons dashicons-edit"></i>', '<i class="dashicons dashicons-plus"></i>', '<i class="dashicons dashicons-yes"></i>', '<i class="dashicons dashicons-no"></i>', '<i class="dashicons dashicons-trash"></i>' ); ?></p>
