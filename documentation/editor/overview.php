...
<p><?php printf( __( 'By default, editing of the source text is disabled, since you would need to edit the associated package’s PHP code to match. If you know what you’re doing though and need to edit source text, click the %s icon to enable source text editing.' ), '<i class="dashicons dashicons-welcome-write-blog"></i>' ); ?></p>
