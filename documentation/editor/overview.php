...
<p><?php printf( __( 'By default, editing of the source text and context is disabled, since you would need to edit the associated package’s PHP code to match. If you know what you’re doing though and need to edit these, click the %s icon to enable advanced editing.' ), '<i class="dashicons dashicons-unlock"></i>' ); ?></p>
